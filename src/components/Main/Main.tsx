      ...
      <div className="card-container">
        <div className="card">
          ...
          <div className="second-content">
            <div>
              <span>Goals:</span>
              <span>{teams[1]?.goals}</span>
            </div>
            <div>
              <span>Victory:</span>
              <span>{teams[1]?.victory}</span>
            </div>
            <div>
              <span>Defeat:</span>
              <span>{teams[1]?.defeat}</span>
            </div>
            <div>
              <span>Draw:</span>
        ...
        <span className="main-vs">VS</span>
        <div className="card blue">
          ...
          <div className="second-content">
            <div>
              <span>Goals:</span>
              <span>{teams[0]?.goals}</span>
            </div>
            <div>
              <span>Victory:</span>
              <span>{teams[0]?.victory}</span>
            </div>
            <div>
              <span>Defeat:</span>
              <span>{teams[0]?.defeat}</span>
            </div>
            <div>
              <span>Draw:</span>
